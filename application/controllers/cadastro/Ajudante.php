...
class Ajudante extends MS_Controller {

    private $tela = 'cadastro/ajudante/';
    private $titulo = 'Ajudantes';

    function __construct() 
    {
        parent::__construct();
        $this->load->model('usina/ajudante_model', 'registro', false);
    ...
    { 
        ...
        if ($get['descricao'] != '')
            $like[] = ['campo' => 'nm_ajudante', 'valor' => $post['descricao']];
