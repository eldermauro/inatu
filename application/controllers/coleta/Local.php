...
class Local extends MS_Controller {

    private $tela = 'coleta/local/';
    private $titulo = 'Locais de Coletas';

    function __construct() 
    {
        parent::__construct();

        $this->load->model('usina/Coleta_localidade_model', 'registro', false);
