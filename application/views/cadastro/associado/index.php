                    ...
                    <div class="col-lg-8">
                        <form action="<?= base_url($tela) ?>" method="POST" class="row gx-3 gy-2 align-items-center">
                            <div class="hstack gap-3"> 
                                ...
                                <select name="Filter[ativo]"  class="form-control me-auto">
                                    <option value="">Todos status</option>
                                    <option <?=(set_value('Filter[ativo]') == 'S' ? 'selected' : '')?> value="S">Ativos</option>
                                    <option <?=(set_value('Filter[ativo]') == 'N' ? 'selected' : '')?> value="N">Inativos</option>
                                </select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-3"> 
                                        <a href="<?= base_url($tela . $r->cd_pessoa . '') ?>" class="text-success" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Editar">
